            ...
            <tr>
              ...
              >
                <input
                  ...
                  placeholder="Section"
                  onChange={(e) =>
                    handleSearchChange("section", e.target.value)
                  }
                  className="filter w-full px-2 py-1 rounded filter-input"
                />
              </th>
                  ...
                  <td className="px-2 py-2 text-center border-b border-gray-200 bg-white text-sm">
                    <div className="flex items-center">
                      <div className="ml-3">
                        ...
                        >
                          <p className="text-gray-900 whitespace-no-wrap">
                            {item.file.replace("public/uploads/", "").length >
                            25
                              ? item.file
      ...
      <section>
        <div>
          ...
          <div className="flex justify-between my-5">
            ...
            {permissionsData && permissionsData.includes("files.add_pdf") && (
              <div className="flex">
        ...
        <div className="bg-white p-8 rounded-md w-full m-auto dashed overflow-auto dashboard_table">
