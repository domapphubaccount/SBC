...
import { DeleteUser } from "./DashModules/Delete";
import { EditUser } from "./DashModules/Edit";
import { ViewUser } from "./DashModules/View";
import { WarnUser } from "./DashModules/Warn";
                  ...
                  <table className="min-w-full leading-normal font-semibold">
                    ...
                    {new Array(5).fill(null).map((_, i) =>(
                      <tr className="user_row">
                        ...
                        <td className="px-2 py-2 border-b border-gray-200 bg-white text-sm">
                            <div className="hover:font-bold cursor-pointer" onClick={handleOpenWarn}>Admin</div>
                        </td>
                        <td className="px-2 py-2 border-b border-gray-200 bg-white text-sm">
