...
import { addReviewAction } from "@/app/Redux/Features/Dashboard/ReviewerSlice";
...
export function AddReview({ openAdd, handleClose }) {
  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      comment_super_reviewr: Yup.string().required(
        "Super reviewer comment is required"
      ),
      status: Yup.string()
                ...
                permissionsData.includes("chat_user_dislikes.get") ? (
                  ...
                  <div>
                    <small className="text-red-700	">
                      You need "Users Dislikes" permission to add a Review
                    </small>
                  </div>
                )}
