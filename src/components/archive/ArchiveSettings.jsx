...
function ArchiveSettings({setRenameToggle,setDeleteToggle,item,setHandleChat, setShareToggle}) {
  ...
  return (
    <div className='relative'>
      <svg onClick={toggleDropdown} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="black" className="size-6 cursor-pointer">
      ...
      {dropdownOpen && (
        <div className="absolute z-10 right-0 mt-2 bg-white border rounded shadow-md">
          <ul>
            ...
            <li onClick={()=>{setRenameToggle(true);setHandleChat(item)}} className="py-1 px-3 hover:bg-gray-100 flex items-center cursor-pointer">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-3 mr-3">
            ...
            <li onClick={()=>{setDeleteToggle(true);setHandleChat(item)}} className="py-1 px-3 hover:bg-gray-100 flex items-center cursor-pointer">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-3 mr-3">
