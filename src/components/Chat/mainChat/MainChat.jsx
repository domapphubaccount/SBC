...
function MainChat({elementWidth,storedCode,insideChat,update,setUpdate}) {
            ...
            <div className='relative'>
                ...
                <div>
                  ...
                  <div className='flex mb-3'>
                    <svg onClick={()=>handleReadText('اهلا ')} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="black" className="size-3.5 ml-2 cursor-pointer">
                    ...
                    <svg onClick={handleDislike} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="black" className="size-3.5 ml-2 cursor-pointer">
