  ...
  return (
    <nav className="absolute w-full">
      <div className="flex justify-between">
        <div className="flex">
          {/* start sidebar icon */}
          <div className="p-2 mr-4 rounded-full hover-icon cursor-pointer">
            <svg
        ...
        {/* start dropdown */}
        <div className="p-2">
          <div class="flex items-center justify-center w-full mt-auto" href="#">
            <svg
      ...
      <div class="flex flex-col items-center w-40 h-full overflow-hidden text-gray-700 bg-gray-100 rounded">
        ...
        <div class="w-full px-2">
          ...
          <div class="flex flex-col items-center w-full mt-2 border-t border-gray-300">
            ...
            <a
              class="relative flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-gray-300"
              href="#"
            >
              <svg
                class="w-6 h-6 stroke-current"
